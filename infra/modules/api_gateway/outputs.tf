...
output "deployment_invoke_url" {
  description = "Invoke URL for deployed stage (e.g. https://{id}.execute-api.{region}.amazonaws.com/api/v1)"
  value       = "https://${aws_api_gateway_rest_api.this.id}.execute-api.us-east-1.amazonaws.com/api/v1"
}